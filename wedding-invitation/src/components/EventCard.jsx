  ...
  return (
    ...
    >
      ...
      <div className="space-y-6 text-center">
        <div className="bg-gradient-to-r from-cream/50 to-amber-50/50 rounded-lg p-4 transform transition-transform duration-300 hover:scale-105">
          ...
          <p className="font-serif text-2xl md:text-3xl text-brown font-semibold mb-1">
            {date}
          </p>
          <p className="font-cormorant text-xl md:text-2xl text-brown/70">
            {day}
          </p>
        </div>

        <div className="bg-gradient-to-r from-amber-50/50 to-cream/50 rounded-lg p-4 transform transition-transform duration-300 hover:scale-105">
          <div className="flex items-center justify-center space-x-2 mb-2">
